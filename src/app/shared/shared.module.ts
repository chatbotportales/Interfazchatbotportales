...
import { DialogflowModalComponent } from './components/dialogflow-modal/dialogflow-modal.component';
...
@NgModule({
  declarations: [
    ...
    CoursesModalComponent, FrequentquestionsModalComponent, PortalinfomodalComponent, DialogflowModalComponent
  ],
  exports: [
